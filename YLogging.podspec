...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Vijay Vepakomma"
  # s.authors            = { "Vijay Vepakomma" => "vijay.vepakomma@philips.com" }
  # s.social_media_url   = "http://twitter.com/Vijay Vepakomma"
  ...
  s.source       = { :git => "https://github.com/vijayvepa/YLogging.git", :tag => "v0.0.1" }
